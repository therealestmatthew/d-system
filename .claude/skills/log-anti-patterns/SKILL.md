...
description: "Route a described anti-pattern to the records that should hold it — the concurrency-collision ledger, a brain procedure, an idea, the session record — and write the ones the owner confirms."
---
