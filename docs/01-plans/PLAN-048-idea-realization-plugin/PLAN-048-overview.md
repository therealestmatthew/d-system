...
| `phase-plug-06` | [PLAN-048.06](PLAN-048.06-generators-layout.md) | Two generators, layout reference, AGENTS.md and CLAUDE.md templates, the generated tools reference and the tools skill |
...
| R25 | `phase-plug-06` (`docs/tools.md`, `tools` skill) |
