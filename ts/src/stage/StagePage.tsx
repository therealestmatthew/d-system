...
export default function StagePage() {
  const { loadState, layouts, activeLayout, setActiveLayoutId, getSlotPanel, setSlotPanel } =
    useWorkbenchLayouts()
          ...
          {activeLayout.slots.map((slot) => (
            ...
            >
              <Slot
                ...
                onSelectPanel={(panelId) => setSlotPanel(activeLayout.layout_id, slot.slot_id, panelId)}
              />
            </div>
          ))}
        </main>
